...
private extension SettingsVC {
    func setTargets() {
        ...
        self.personalDetailsButton.addTarget(self, action: #selector(personalDetailsTouch), for: .touchUpInside)
    ...
    @objc
    func personalDetailsTouch() {
        let vc = Utils.shared.mainStoryboard().instantiateViewController(withIdentifier: PersonalDetailsVC.className)
        self.present(vc, animated: true)
    }
